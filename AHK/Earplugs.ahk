...
global fVolHigh:=1.0
global fVolLow:=0.17
global bEarplugs:=false

Insert::reload

;Mouse4 and Shift+Mouse4
XButton2::funcEarplugs()
+XButton2::funcEarplugs()
...
funcEarplugs()
{
  ...
  {
    bEarplugs:=true
    VA_ISimpleAudioVolume_setMasterVolume(Volume, fVolLow)
  }
  else
  {
    bEarplugs:=false
    VA_ISimpleAudioVolume_setMasterVolume(Volume, fVolHigh)
  }
  ;Toggle volume
  ObjRelease(Volume)
  return
